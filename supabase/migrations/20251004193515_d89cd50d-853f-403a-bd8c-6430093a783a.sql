...
-- Add index for faster correlation_id lookups
CREATE INDEX idx_execution_logs_correlation_id ON public.execution_logs(correlation_id);
CREATE INDEX idx_execution_logs_plan_id ON public.execution_logs(plan_id);
