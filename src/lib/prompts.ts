...
export const prompts = {
  ui: {
    ...
    toasts: {
      ...
      credentialsFailed: 'Failed to save credentials. Please try again.',
      draftSaved: 'Draft saved automatically.',
      draftLoaded: 'Draft loaded.',
      paymentMethodSaved: 'Payment method saved successfully.',
      paymentMethodFailed: 'Failed to save payment method.',
      mandateCreated: 'Mandate created successfully.',
      mandateFailed: 'Failed to create mandate. Please try again.',
      registrationSuccess: 'Registration completed successfully.',
      registrationFailed: 'Registration failed. Please check the details and try again.',
      dataRefreshed: 'Data refreshed successfully.',
      jobStarted: 'Signup job started successfully.',
      jobFailed: 'Failed to start signup job. Please try again.',
    },
