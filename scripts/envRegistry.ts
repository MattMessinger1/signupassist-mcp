...
export const ENV_DEFINITIONS: EnvDefinition[] = [
  ...
  },
  {
    ...
    category: "Worker",
    description: "Explicit opt-in for supervised SMS reminders.",
    example: "false",
    defaultValue: "false",
    targets: { local: "optional", "railway-worker": "optional" },
  },
  {
    name: "TWILIO_ACCOUNT_SID",
    category: "Worker",
    description: "Twilio account SID used for supervised SMS reminders.",
    secret: true,
  ...
  },
  {
    ...
    category: "Worker",
    description: "Twilio auth token used for supervised SMS reminders.",
    secret: true,
  ...
  },
  {
    ...
    category: "Worker",
    description: "Twilio From number in E.164 format used for supervised SMS reminders.",
    example: "+15551234567",
    targets: { local: "optional", "railway-worker": "optional" },
  },
  {
